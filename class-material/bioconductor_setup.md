...
As we already noted back in [Lecture 6]({{ site.baseurl }}/schedule/#6) that Bioconductor is a large repository and resource for R packages that focus on analysis of high-throughput genomic data.  
...
> Note that the R console may prompt you to respond Y/N to some questions and you will miss these if you paste multiple lines at once.
